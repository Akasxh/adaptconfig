...
\begin{center}
\includegraphics[width=0.85\textwidth]{qa-dashboard-full.png}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.85\textwidth]{09-config-generated.png}
\end{center}
...
% ── 12. ADAPTERS ─────────────────────────────────────────────────────────────
\begin{frame}{Adapter Catalog (8 Pre-Built)}
\begin{center}
\includegraphics[width=0.85\textwidth]{qa-adapters.png}
\end{center}
{\small\centering CIBIL $\cdot$ eKYC $\cdot$ GST $\cdot$ Payment $\cdot$ Fraud $\cdot$ SMS $\cdot$ Account Aggregator $\cdot$ Email\par}
\end{frame}

% ── 13. SEARCH ───────────────────────────────────────────────────────────────
\begin{frame}{Search \& Audit}
\begin{columns}
\begin{column}{0.48\textwidth}
\includegraphics[width=\textwidth]{qa-search-results.png}
\vspace{0.2em}
{\scriptsize Fuzzy search across adapters, configs, simulations}
\end{column}
\begin{column}{0.48\textwidth}
\includegraphics[width=\textwidth]{qa-audit.png}
\vspace{0.2em}
{\scriptsize Immutable audit trail with filters \& pagination}
\end{column}
\end{columns}
\end{frame}
