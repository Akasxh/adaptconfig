...
\vspace{1.5em}
{\Large\color{tp} Questions?}

\vspace{2em}
{\small\color{ts}
\begin{tabular}{rl}
\textcolor{teal}{Live Demo} & \url{https://adaptconfig-frontend-production.up.railway.app} \\[4pt]
\textcolor{teal}{API Docs} & \url{https://adaptconfig-api-production.up.railway.app/docs} \\[4pt]
\textcolor{teal}{Source Code} & \url{https://github.com/Akasxh/adaptconfig} \\
\end{tabular}
}

\vspace{2em}
{\normalsize\color{tp}\bfseries Team Nucleolus}\\[4pt]
{\small\color{ts} S Akash \quad$\cdot$\quad Swayam Jain \quad$\cdot$\quad Yash Kamdar}\\[2pt]
{\small\color{ts} Indian Institute of Technology, Patna}
\end{center}
\end{frame}
